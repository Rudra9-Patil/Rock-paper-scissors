...
@Component({
  selector: 'app-game-playercomputer',
  templateUrl: './game-playercomputer.component.html',
  styleUrls: ['./game-playercomputer.component.scss']
})
export class GamePlayercomputerComponent implements OnInit {
  playerScore:any=[]
